...
const ResetPortfolioSection: React.FC<ResetPortfolioSectionProps> = ({ onResetClick }) => (
  <section className="rounded border border-slate-200 bg-white p-6 text-sm text-slate-700">
    ...
    <button
      ...
      className="mt-4 w-full rounded border border-red-200 px-4 py-2 text-sm font-semibold text-red-600 transition hover:bg-red-50"
    >
      데이터 초기화 진행
    </button>
  </section>
