          ...
          <section className="rounded border border-slate-200 bg-white p-6 text-sm text-slate-700 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              ...
              {user ? (
                <Link
                  to="/subscription"
                  className="inline-flex flex-shrink-0 items-center gap-2 rounded border border-slate-300 px-3 py-1.5 text-xs font-semibold text-slate-600 transition hover:bg-slate-100 hover:text-slate-900 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800"
                >
                  관리
                </Link>
              ) : (
                <button
                  type="button"
                  onClick={handleLogin}
                  className="inline-flex flex-shrink-0 items-center gap-2 rounded-full border border-slate-300 px-4 py-2 text-xs font-semibold text-slate-600 transition hover:bg-slate-100 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800"
                >
                  Google 로그인
                </button>
              )}
